    ...
    $.mbExtruder = {
        ...
        buildMbExtruder: function(options) {
            return this.each(function() {
                ...
                var c = $("<div/>").addClass("extruder-content").css({
                    overflow: "hidden",
                    width: extW
                });
                ...
                c.on("mouseleave", function(e) {
                    if (extruder.get(0).options.closeOnExternalClick) {
                        ...
                        if (!$(e.target).parents().is(".text")) $(document).one("click.extruder" + extruder.get(0).idx, function() {
                            extruder.closeMbExtruder();
                        });
                    }
        ...
        setMbExtruderContent: function(options) {
            ...
            if (!($.browser.msie && $.browser.version <= 7)) container.css({
        ...
        openMbExtruder: function(c) {
            ...
            if (position == "top" || position == "bottom") {
                ...
                extruder.find('.extruder-content').animate({
                    width: opt.width
                }, opt.slideTimer);
                if (opt.onExtOpen) opt.onExtOpen();
            }
